...
#define LUMA_TU_TYPED_CAN_USE_SVE(prim, fncdef, fname) p.cu[BLOCK_32x32].prim = fncdef PFX(fname##_32x32_##sve)
...
#define CHROMA_420_PU_CAN_USE_SVE_EXCEPT_FILTER_PIXEL_TO_SHORT(prim, fname) \
    CHROMA_420_PU_TYPED_CAN_USE_SVE_EXCEPT_FILTER_PIXEL_TO_SHORT(prim, , fname)
...
#define CHROMA_422_PU_CAN_USE_SVE_EXCEPT_FILTER_PIXEL_TO_SHORT(prim, fname) \
    CHROMA_422_PU_TYPED_CAN_USE_SVE_EXCEPT_FILTER_PIXEL_TO_SHORT(prim, , fname)
...
void setupSve2BitPermPrimitives(EncoderPrimitives &p) { p.scanPosLast = PFX(scanPosLast_sve2_bitperm); }
