...
void* x265_malloc(size_t size) { return _aligned_malloc(size, X265_ALIGNBYTES); }
...
double x265_qScale2qp(double qScale) { return 12.0 + 6.0 * (double)X265_LOG2(qScale / 0.85); }

double x265_qp2qScale(double qp) { return 0.85 * pow(2.0, (qp - 12.0) / 6.0); }
