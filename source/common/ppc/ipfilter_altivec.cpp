...
#define multiply_pixel_coeff(/*vector int*/ v_sum_0, /*vector int*/ v_sum_1, /*vector int*/ v_sum_2, /*vector int*/ v_sum_3, /*const pixel * */ src, \
                             /*int*/ src_offset, /*vector signed short*/ v_coeff)                                                                    \
    {                                                                                                                                                \
...
#define multiply_accumulate_pixel_coeff(/*vector int*/ v_sum_0, /*vector int*/ v_sum_1, /*vector int*/ v_sum_2, /*vector int*/ v_sum_3, \
                                        /*const pixel * */ src, /*int*/ src_offset, /*vector signed short*/ v_coeff)                    \
    {                                                                                                                                   \
        vector unsigned char v_pixel;                                                                                                   \
        vector signed short v_pixel_16_h, v_pixel_16_l;                                                                                 \
...
// ORIGINAL : for(col=0; col<16; col++) {sum[col]  = src[ocol+col + 0 * srcStride] * c[0];}
#define multiply_sp_pixel_coeff(/*vector int*/ v_sum_0, /*vector int*/ v_sum_1, /*vector int*/ v_sum_2, /*vector int*/ v_sum_3, \
                                /*const int16_t * */ src, /*int*/ src_offset, /*vector signed short*/ v_coeff)                  \
    {                                                                                                                           \
        vector signed short v_pixel_16_h, v_pixel_16_l;                                                                         \
                                                                                                                                \
        /* load the pixels */                                                                                                   \
...
// ORIGINAL : for(col=0; col<16; col++) {sum[col] += src[ocol+col + 1 * srcStride] * c[1];}
#define multiply_accumulate_sp_pixel_coeff(/*vector int*/ v_sum_0, /*vector int*/ v_sum_1, /*vector int*/ v_sum_2, /*vector int*/ v_sum_3, \
                                           /*const pixel * */ src, /*int*/ src_offset, /*vector signed short*/ v_coeff)                    \
    {                                                                                                                                      \
        vector signed short v_pixel_16_h, v_pixel_16_l;                                                                                    \
        vector int v_product_int_0, v_product_int_1, v_product_int_2, v_product_int_3;                                                     \
