...
#define DECL_SAO(cpu)                                                                                                                          \
    ...
    void PFX(saoCuStatsE1_##cpu)(const int16_t *diff, const pixel *rec, intptr_t stride, int8_t *upBuff1, int endX, int endY, int32_t *stats,  \
                                 int32_t *count);                                                                                              \
    void PFX(saoCuStatsE2_##cpu)(const int16_t *diff, const pixel *rec, intptr_t stride, int8_t *upBuff1, int8_t *upBufft, int endX, int endY, \
                                 int32_t *stats, int32_t *count);                                                                              \
    void PFX(saoCuStatsE3_##cpu)(const int16_t *diff, const pixel *rec, intptr_t stride, int8_t *upBuff1, int endX, int endY, int32_t *stats,  \
                                 int32_t *count);                                                                                              \
