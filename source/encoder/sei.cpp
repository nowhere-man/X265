...
const uint8_t SEIuserDataUnregistered::m_uuid_iso_iec_11578[16] = {0x2C, 0xA2, 0xDE, 0x09, 0xB5, 0x17, 0x47, 0xDB,
...
void SEI::setSize(uint32_t size) { m_payloadSize = size; }
